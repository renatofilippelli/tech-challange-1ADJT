package filippelli.renato.techchallange1adjt.domain.controller;

import filippelli.renato.techchallange1adjt.domain.dto.AddressRequest;
import filippelli.renato.techchallange1adjt.domain.service.AddressService;
...
public class AddressController {
    ...
    @PostMapping
    public ResponseEntity<AddressRequest> save(@RequestBody AddressRequest address) {
    ...
    @Operation(summary = "List all adresses", method = "GET")
    @ApiResponses(value = {
    ...
    @GetMapping
    public ResponseEntity<Collection<AddressRequest>> findAll() {
        return ResponseEntity
                .ok()
    ...
    @GetMapping("/{id}")
    public ResponseEntity<AddressRequest> findById(@PathVariable UUID id) {
        return ResponseEntity
                .ok()
